...
it('edits a profile', closure: function () {
    ...
    it(/**
     * @throws Exception
     */ 'notifies the original email if updated', function () {
        $user = User::factory()->create();
        ...
        Notification::assertSentOnDemand(EmailChanged::class, function ($notification, $routes, $notifiable) use ($originalEmail) {
